...
# Production Deployment Script for Terraform S3 + CloudFront Infrastructure
# Usage: ./deploy-prod.sh [plan|apply|destroy]
...
terraform_apply() {
    ...
    # Confirmation prompt
    echo ""
    print_warning "⚠️  You are about to apply changes to PRODUCTION environment!"
    print_warning "⚠️  This will modify real AWS resources and may incur costs."
    echo ""
...
terraform_destroy() {
    print_warning "⚠️  DANGER: You are about to DESTROY the PRODUCTION environment!"
    print_warning "⚠️  This will DELETE all AWS resources managed by this Terraform configuration!"
    echo ""
    print_error "This action is IRREVERSIBLE!"
    echo ""
    read -p "Type 'DELETE' in capital letters to confirm destruction: " confirm
...
show_help() {
    ...
    echo "  destroy  - Destroy all resources (DANGEROUS!)"
...
main() {
    clear
    echo "=========================================="
    echo "🚀 Terraform Production Deployment Script"
    echo "=========================================="
    echo ""
